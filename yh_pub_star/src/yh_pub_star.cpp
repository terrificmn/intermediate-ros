...
#include "yh_pub_star/yh_topic_star.h" // 패키지 이름/메세지파일이름.h 
...
int main(int argc, char **argv) {
    ...
    ros::Publisher pub = nh.advertise < yh_pub_star::yh_topic_star >("yh_topic_star", 100);
    ...
    yh_pub_star::yh_topic_star msg;  //yh_pub_star의 yh_topic_star 의 내가 만든 메시지 파일 형식으로 msg를 선언해준다
