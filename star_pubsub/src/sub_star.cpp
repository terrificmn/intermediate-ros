#include "ros/ros.h"
#include "iostream"
#include "star_pubsub/topic_star.h"

using namespace std;

void msgCallback (const star_pubsub::topic_star::ConstPtr&msg) { // 파라미터를 상수 형태로 끊어서 사용하겠다
...
int main(int argc, char **argv) {
    ...
    // msgCallback을 호출한다
    ros::Subscriber sub = nh.subscribe("topic_star", 100, msgCallback);
